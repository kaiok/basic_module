...
public class FileTest {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // 以当前路径来创建一个File对象
        var file = new File("/Users/kais/Downloads");
        // 直接获取文件名，输出一点
        ...
        // 获取上一级路径
        System.out.println("上一级目录绝对路径" + file.getAbsoluteFile().getParent());
        // 在当前路径下创建一个临时文件
...
//            System.out.println("文件名为：" + file1.getName() + " 是否为Directory:" + file1.isDirectory() + " 是否为File：" + file1.isFile());
//        }
